...
const Carrousel = () => {
  ...
  useEffect(()=>{
    getData()
    console.log("se volvió a ejecutar")
  }, [])
  ...
  return (
    <div className="w-full h-[40vh]  flex justify-center items-center">
      <div className="px-4 flex gap-8 justify-center items-end relative w-9/12 h-5/6 rounded bg-gradient-to-r from-[#434343] to-[#000]">
        <img
          className="w-6 absolute top-1/2 left-4 cursor-pointer rotate-180"
          src="./images/arrow-right.svg"
          alt="arrow"
          onClick={prev}
        />
        <img
          className="w-6 absolute top-1/2 right-4 cursor-pointer "
          src="./images/arrow-right.svg"
          alt="arrow"
          onClick={next}
        />
        ...
        <div className="flex flex-col gap-2 self-center">
          <h5 className="text-white font-bold text-xl">{categories[counter]?.name}</h5>
